...
import { ArrowLeft, FileText, Settings, Database, Filter, Download, Upload, Code } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" onClick={() => navigate('/')}>
              ...
              Terug naar Excel naar Winfakt
            </Button>
            <div>
              <h1 className="text-2xl font-bold">Excel naar Winfakt - Documentatie</h1>
              <p className="text-muted-foreground">Uitgebreide handleiding en mogelijkheden</p>
            </div>
          </div>
        </div>
      </div>
