...
const ConfigurationMenu = ({ onSaveNew, onSave, onExportSettings, onLoadSettings, onInfo, onClearSettings, onShowLog, isSaving }: ConfigurationMenuProps) => {
